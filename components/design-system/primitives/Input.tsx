...
export default function Input({
  ...
  const { tokens, getTextColor, getTextSecondaryColor, getBorderColor, getSurfaceColor } = useTheme();
  ...
  const backgroundColor = disabled ? tokens.colors.neutral.gray100 : getSurfaceColor();
